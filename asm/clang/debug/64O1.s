...
.Lfunc_begin0:
	.file	1 "../src" "64.c"
	.loc	1 5 0                   # ../src/64.c:5:0
	.cfi_startproc
# %bb.0:
	.loc	1 9 5 prologue_end      # ../src/64.c:9:5
	pushq	%rax
...
.Linfo_string1:
	.asciz	"../src/64.c"           # string offset=54
.Linfo_string2:
...
.Linfo_string5:
	.asciz	"val"                   # string offset=113
.Linfo_string6:
	.asciz	"long long unsigned int" # string offset=117
.Linfo_string7:
	.asciz	"__u64"                 # string offset=140
...
.Lcu_begin0:
	...
	.byte	5                       # Abbrev [5] 0x5d:0xb DW_TAG_typedef
	.long	104                     # DW_AT_type
...
.LpubNames_begin0:
	...
	.long	112                     # Compilation Unit Length
	.long	42                      # DIE offset
