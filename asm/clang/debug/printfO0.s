...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/printf.c" md5 0xfb88f6363b97b88f7f1a10217c099395
	.loc	0 4 0                           # ../src/printf.c:4:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	...
	movl	$0, -4(%rbp)
.Ltmp0:
	.loc	0 5 5 prologue_end              # ../src/printf.c:5:5
	leaq	.L.str(%rip), %rdi
	movb	$0, %al
	callq	printf@PLT
	.loc	0 7 5                           # ../src/printf.c:7:5
	xorl	%eax, %eax
	addq	$16, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.Linfo_string1:
	.asciz	"../src/printf.c"               # string offset=28
.Linfo_string2:
