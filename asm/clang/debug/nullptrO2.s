...
.Lfunc_begin0:
	...
	.cfi_startproc
# %bb.0:
	.loc	1 7 13 prologue_end     # ../src/nullptr.c:7:13
	pushq	%rax
	.cfi_def_cfa_offset 16
	movq	stdout(%rip), %rdi
	.loc	1 7 5 is_stmt 0         # ../src/nullptr.c:7:5
	movl	$.L.str, %esi
	xorl	%edx, %edx
	xorl	%eax, %eax
	callq	fprintf
...
.Lcu_begin0:
	...
	.byte	3                       # Abbrev [3] 0x2b:0x25 DW_TAG_subprogram
	.quad	.Lfunc_begin0           # DW_AT_low_pc
	.long	.Lfunc_end0-.Lfunc_begin0 # DW_AT_high_pc
	...
	.byte	5                       # Abbrev [5] 0x50:0x7 DW_TAG_base_type
