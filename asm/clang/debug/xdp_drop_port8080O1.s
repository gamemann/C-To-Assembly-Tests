...
# %bb.0:
	...
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r1
.Ltmp0:
	.loc	7 18 30 prologue_end    # ../src/xdp_drop_port8080.c:18:30
	r2 = *(u32 *)(r1 + 4)
.Ltmp1:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 17 26                 # ../src/xdp_drop_port8080.c:17:26
	r3 = *(u32 *)(r1 + 0)
.Ltmp2:
	#DEBUG_VALUE: xdp_prog_main:eth <- %r3
	.loc	7 22 13                 # ../src/xdp_drop_port8080.c:22:13
	r1 = r3
.Ltmp3:
	r1 += 14
.Ltmp4:
	.loc	7 22 9 is_stmt 0        # ../src/xdp_drop_port8080.c:22:9
...
# %bb.1:
	...
	.loc	7 29 13 is_stmt 1       # ../src/xdp_drop_port8080.c:29:13
	r3 += 34
.Ltmp6:
	.loc	7 29 9 is_stmt 0        # ../src/xdp_drop_port8080.c:29:9
	if r3 > r2 goto LBB0_5
.Ltmp7:
# %bb.2:
	#DEBUG_VALUE: xdp_prog_main:iph <- %r1
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 34 64 is_stmt 1       # ../src/xdp_drop_port8080.c:34:64
	r3 = *(u8 *)(r1 + 0)
	.loc	7 34 68 is_stmt 0       # ../src/xdp_drop_port8080.c:34:68
	r3 <<= 2
	r3 &= 60
...
.Ltmp8:
	...
	.loc	7 36 14 is_stmt 1       # ../src/xdp_drop_port8080.c:36:14
	r3 = r1
	r3 += 20
.Ltmp9:
	.loc	7 36 9 is_stmt 0        # ../src/xdp_drop_port8080.c:36:9
	if r3 > r2 goto LBB0_5
.Ltmp10:
# %bb.3:
	#DEBUG_VALUE: xdp_prog_main:tcph <- %r1
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 41 15 is_stmt 1       # ../src/xdp_drop_port8080.c:41:15
	r1 = *(u16 *)(r1 + 2)
.Ltmp11:
	.loc	7 0 15 is_stmt 0        # ../src/xdp_drop_port8080.c:0:15
	r0 = 1
.Ltmp12:
...
# %bb.4:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 0 9 is_stmt 0         # ../src/xdp_drop_port8080.c:0:9
	r0 = 2
.Ltmp14:
LBB0_5:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 47 1 is_stmt 1        # ../src/xdp_drop_port8080.c:47:1
	exit
.Ltmp15:
.Lfunc_end0:
	.cfi_endproc
