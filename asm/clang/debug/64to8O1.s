...
.Ltmp0:
	...
	.loc	0 24 5 prologue_end             # ../src/64to8.c:24:5
	leaq	.L.str(%rip), %rdi
	movabsq	$8128420482184, %rsi            # imm = 0x7648B9D8C88
	xorl	%eax, %eax
	callq	printf@PLT
.Ltmp1:
	.loc	0 26 5                          # ../src/64to8.c:26:5
	xorl	%eax, %eax
	popq	%rcx
