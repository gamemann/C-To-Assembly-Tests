...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/fprintf.c" md5 0xa9a81cfcd6d7d64f72bb64bb4cd42089
	.loc	0 4 0                           # ../src/fprintf.c:4:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	...
	movl	$0, -4(%rbp)
.Ltmp0:
	.loc	0 5 13 prologue_end             # ../src/fprintf.c:5:13
	movq	stdout@GOTPCREL(%rip), %rax
	movq	(%rax), %rdi
	.loc	0 5 5 is_stmt 0                 # ../src/fprintf.c:5:5
	leaq	.L.str(%rip), %rsi
	movb	$0, %al
	callq	fprintf@PLT
	.loc	0 7 5 is_stmt 1                 # ../src/fprintf.c:7:5
	xorl	%eax, %eax
	addq	$16, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.Linfo_string1:
	.asciz	"../src/fprintf.c"              # string offset=28
.Linfo_string2:
