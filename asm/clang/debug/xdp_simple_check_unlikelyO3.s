...
# %bb.0:
	...
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r1
.Ltmp0:
	.loc	7 15 30 prologue_end    # ../src/xdp_simple_check_unlikely.c:15:30
	r2 = *(u32 *)(r1 + 4)
.Ltmp1:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 14 26                 # ../src/xdp_simple_check_unlikely.c:14:26
	r3 = *(u32 *)(r1 + 0)
.Ltmp2:
	#DEBUG_VALUE: xdp_prog_main:eth <- %r3
	.loc	7 19 9                  # ../src/xdp_simple_check_unlikely.c:19:9
	r1 = r3
.Ltmp3:
	r1 += 14
.Ltmp4:
...
# %bb.2:
	#DEBUG_VALUE: xdp_prog_main:iph <- %r1
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 31 64 is_stmt 1       # ../src/xdp_simple_check_unlikely.c:31:64
	r3 = *(u8 *)(r1 + 0)
	.loc	7 31 68 is_stmt 0       # ../src/xdp_simple_check_unlikely.c:31:68
	r3 <<= 2
	r3 &= 60
...
.Ltmp8:
	...
	r1 += 20
.Ltmp9:
	.loc	7 0 9 is_stmt 0         # ../src/xdp_simple_check_unlikely.c:0:9
	r0 = 1
.Ltmp10:
...
LBB0_4:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 39 1 is_stmt 1        # ../src/xdp_simple_check_unlikely.c:39:1
	exit
.Ltmp13:
.Lfunc_end0:
	.cfi_endproc
