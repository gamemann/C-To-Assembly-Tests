...
.Ltmp0:
	...
	.loc	3 14 30 prologue_end    # ../src/xdp_adjust_head.c:14:30
	r1 = *(u32 *)(r6 + 4)
.Ltmp1:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r1
	.loc	3 13 26                 # ../src/xdp_adjust_head.c:13:26
	r3 = *(u32 *)(r6 + 0)
.Ltmp2:
	#DEBUG_VALUE: xdp_prog_main:eth <- %r3
	.loc	3 18 13                 # ../src/xdp_adjust_head.c:18:13
	r2 = r3
	r2 += 14
.Ltmp3:
	.loc	3 18 9 is_stmt 0        # ../src/xdp_adjust_head.c:18:9
...
# %bb.1:
	...
	.loc	3 25 13 is_stmt 1       # ../src/xdp_adjust_head.c:25:13
	r3 += 34
.Ltmp5:
	.loc	3 0 13 is_stmt 0        # ../src/xdp_adjust_head.c:0:13
	r0 = 1
.Ltmp6:
...
# %bb.2:
	...
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r1
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r6
	.loc	3 30 64 is_stmt 1       # ../src/xdp_adjust_head.c:30:64
	r3 = *(u8 *)(r2 + 0)
	.loc	3 30 68 is_stmt 0       # ../src/xdp_adjust_head.c:30:68
	r3 <<= 2
	r3 &= 60
...
.Ltmp8:
	...
	.loc	3 32 14 is_stmt 1       # ../src/xdp_adjust_head.c:32:14
	r2 += 20
.Ltmp9:
	.loc	3 0 14 is_stmt 0        # ../src/xdp_adjust_head.c:0:14
	r0 = 1
.Ltmp10:
...
# %bb.3:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r1
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r6
	.loc	3 37 9 is_stmt 1        # ../src/xdp_adjust_head.c:37:9
	r1 = r6
.Ltmp12:
	r2 = 14
	call 44
	...
	r1 >>= 32
.Ltmp13:
	.loc	3 37 9 is_stmt 0        # ../src/xdp_adjust_head.c:37:9
	if r1 != 0 goto LBB0_8
.Ltmp14:
# %bb.4:
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r6
	.loc	3 43 24 is_stmt 1       # ../src/xdp_adjust_head.c:43:24
	r1 = *(u32 *)(r6 + 4)
.Ltmp15:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r1
	.loc	3 42 20                 # ../src/xdp_adjust_head.c:42:20
	r3 = *(u32 *)(r6 + 0)
.Ltmp16:
	#DEBUG_VALUE: xdp_prog_main:eth <- %r3
	.loc	3 47 13                 # ../src/xdp_adjust_head.c:47:13
	r2 = r3
	r2 += 14
	r0 = 1
.Ltmp17:
	.loc	3 47 9 is_stmt 0        # ../src/xdp_adjust_head.c:47:9
	if r2 > r1 goto LBB0_8
.Ltmp18:
# %bb.5:
	#DEBUG_VALUE: xdp_prog_main:eth <- %r3
	...
	#DEBUG_VALUE: xdp_prog_main:data <- %r3
	#DEBUG_VALUE: xdp_prog_main:iph <- %r2
	.loc	3 54 13 is_stmt 1       # ../src/xdp_adjust_head.c:54:13
	r3 += 34
.Ltmp19:
	.loc	3 0 13 is_stmt 0        # ../src/xdp_adjust_head.c:0:13
	r0 = 1
...
# %bb.6:
	...
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r1
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r6
	.loc	3 59 49 is_stmt 1       # ../src/xdp_adjust_head.c:59:49
	r3 = *(u8 *)(r2 + 0)
	.loc	3 59 53 is_stmt 0       # ../src/xdp_adjust_head.c:59:53
	r3 <<= 2
	r3 &= 60
...
.Ltmp22:
	#DEBUG_VALUE: xdp_prog_main:tcph <- %r2
	.loc	3 61 14 is_stmt 1       # ../src/xdp_adjust_head.c:61:14
	r2 += 20
.Ltmp23:
	.loc	3 0 14 is_stmt 0        # ../src/xdp_adjust_head.c:0:14
	r0 = 1
...
# %bb.7:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r1
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r6
	.loc	3 0 9 is_stmt 0         # ../src/xdp_adjust_head.c:0:9
	r0 = 2
.Ltmp26:
LBB0_8:
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r6
	.loc	3 67 1 is_stmt 1        # ../src/xdp_adjust_head.c:67:1
	exit
.Ltmp27:
.Lfunc_end0:
	.cfi_endproc
