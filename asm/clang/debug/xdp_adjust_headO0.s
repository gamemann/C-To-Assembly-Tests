...
.Lfunc_begin0:
	.loc	3 12 0                  # ../src/xdp_adjust_head.c:12:0
...
# %bb.0:
	...
	*(u64 *)(r10 - 16) = r1
.Ltmp0:
	.loc	3 13 32 prologue_end    # ../src/xdp_adjust_head.c:13:32
	r1 = *(u64 *)(r10 - 16)
	.loc	3 13 26 is_stmt 0       # ../src/xdp_adjust_head.c:13:26
	r1 = *(u32 *)(r1 + 0)
	.loc	3 13 11                 # ../src/xdp_adjust_head.c:13:11
	*(u64 *)(r10 - 24) = r1
	.loc	3 14 36 is_stmt 1       # ../src/xdp_adjust_head.c:14:36
	r1 = *(u64 *)(r10 - 16)
	.loc	3 14 30 is_stmt 0       # ../src/xdp_adjust_head.c:14:30
	r1 = *(u32 *)(r1 + 4)
	.loc	3 14 11                 # ../src/xdp_adjust_head.c:14:11
	*(u64 *)(r10 - 32) = r1
	.loc	3 16 26 is_stmt 1       # ../src/xdp_adjust_head.c:16:26
	r1 = *(u64 *)(r10 - 24)
	.loc	3 16 20 is_stmt 0       # ../src/xdp_adjust_head.c:16:20
	*(u64 *)(r10 - 40) = r1
.Ltmp1:
	.loc	3 18 9 is_stmt 1        # ../src/xdp_adjust_head.c:18:9
	r1 = *(u64 *)(r10 - 40)
	.loc	3 18 13 is_stmt 0       # ../src/xdp_adjust_head.c:18:13
	r1 += 14
	.loc	3 18 36                 # ../src/xdp_adjust_head.c:18:36
	r3 = *(u64 *)(r10 - 32)
.Ltmp2:
	.loc	3 18 9                  # ../src/xdp_adjust_head.c:18:9
	*(u64 *)(r10 - 64) = r2
	if r3 >= r1 goto LBB0_2
	goto LBB0_1
LBB0_1:
.Ltmp3:
	.loc	3 20 9 is_stmt 1        # ../src/xdp_adjust_head.c:20:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_15
.Ltmp4:
LBB0_2:
	.loc	3 23 25                 # ../src/xdp_adjust_head.c:23:25
	r1 = *(u64 *)(r10 - 24)
	.loc	3 23 30 is_stmt 0       # ../src/xdp_adjust_head.c:23:30
	r1 += 14
	.loc	3 23 19                 # ../src/xdp_adjust_head.c:23:19
	*(u64 *)(r10 - 48) = r1
.Ltmp5:
	.loc	3 25 9 is_stmt 1        # ../src/xdp_adjust_head.c:25:9
	r1 = *(u64 *)(r10 - 48)
	.loc	3 25 13 is_stmt 0       # ../src/xdp_adjust_head.c:25:13
	r1 += 20
	.loc	3 25 35                 # ../src/xdp_adjust_head.c:25:35
	r2 = *(u64 *)(r10 - 32)
.Ltmp6:
	.loc	3 25 9                  # ../src/xdp_adjust_head.c:25:9
	if r2 >= r1 goto LBB0_4
	goto LBB0_3
LBB0_3:
.Ltmp7:
	.loc	3 27 9 is_stmt 1        # ../src/xdp_adjust_head.c:27:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_15
.Ltmp8:
LBB0_4:
	.loc	3 30 27                 # ../src/xdp_adjust_head.c:30:27
	r1 = *(u64 *)(r10 - 24)
	.loc	3 30 59 is_stmt 0       # ../src/xdp_adjust_head.c:30:59
	r2 = *(u64 *)(r10 - 48)
	.loc	3 30 64                 # ../src/xdp_adjust_head.c:30:64
	r2 = *(u8 *)(r2 + 0)
	.loc	3 30 56                 # ../src/xdp_adjust_head.c:30:56
	r2 &= 15
	r2 <<= 2
	.loc	3 30 32                 # ../src/xdp_adjust_head.c:30:32
	r1 += r2
	.loc	3 30 56                 # ../src/xdp_adjust_head.c:30:56
	r1 += 14
	.loc	3 30 20                 # ../src/xdp_adjust_head.c:30:20
	*(u64 *)(r10 - 56) = r1
.Ltmp9:
	.loc	3 32 9 is_stmt 1        # ../src/xdp_adjust_head.c:32:9
	r1 = *(u64 *)(r10 - 56)
	.loc	3 32 14 is_stmt 0       # ../src/xdp_adjust_head.c:32:14
	r1 += 20
	.loc	3 32 37                 # ../src/xdp_adjust_head.c:32:37
	r2 = *(u64 *)(r10 - 32)
.Ltmp10:
	.loc	3 32 9                  # ../src/xdp_adjust_head.c:32:9
	if r2 >= r1 goto LBB0_6
	goto LBB0_5
LBB0_5:
.Ltmp11:
	.loc	3 34 9 is_stmt 1        # ../src/xdp_adjust_head.c:34:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_15
.Ltmp12:
LBB0_6:
	.loc	3 37 9                  # ../src/xdp_adjust_head.c:37:9
	r1 = bpf_xdp_adjust_head ll
	r1 = *(u64 *)(r1 + 0)
	.loc	3 37 29 is_stmt 0       # ../src/xdp_adjust_head.c:37:29
	r2 = *(u64 *)(r10 - 16)
	.loc	3 37 9                  # ../src/xdp_adjust_head.c:37:9
	r3 = 14
	*(u64 *)(r10 - 72) = r1
...
LBB0_7:
.Ltmp14:
	.loc	3 39 9 is_stmt 1        # ../src/xdp_adjust_head.c:39:9
	r1 = 0
	*(u32 *)(r10 - 4) = r1
	goto LBB0_15
.Ltmp15:
LBB0_8:
	.loc	3 42 26                 # ../src/xdp_adjust_head.c:42:26
	r1 = *(u64 *)(r10 - 16)
	.loc	3 42 20 is_stmt 0       # ../src/xdp_adjust_head.c:42:20
	r1 = *(u32 *)(r1 + 0)
	.loc	3 42 10                 # ../src/xdp_adjust_head.c:42:10
	*(u64 *)(r10 - 24) = r1
	.loc	3 43 30 is_stmt 1       # ../src/xdp_adjust_head.c:43:30
	r1 = *(u64 *)(r10 - 16)
	.loc	3 43 24 is_stmt 0       # ../src/xdp_adjust_head.c:43:24
	r1 = *(u32 *)(r1 + 4)
	.loc	3 43 14                 # ../src/xdp_adjust_head.c:43:14
	*(u64 *)(r10 - 32) = r1
	.loc	3 45 11 is_stmt 1       # ../src/xdp_adjust_head.c:45:11
	r1 = *(u64 *)(r10 - 24)
	.loc	3 45 9 is_stmt 0        # ../src/xdp_adjust_head.c:45:9
	*(u64 *)(r10 - 40) = r1
.Ltmp16:
	.loc	3 47 9 is_stmt 1        # ../src/xdp_adjust_head.c:47:9
	r1 = *(u64 *)(r10 - 40)
	.loc	3 47 13 is_stmt 0       # ../src/xdp_adjust_head.c:47:13
	r1 += 14
	.loc	3 47 36                 # ../src/xdp_adjust_head.c:47:36
	r2 = *(u64 *)(r10 - 32)
.Ltmp17:
	.loc	3 47 9                  # ../src/xdp_adjust_head.c:47:9
	if r2 >= r1 goto LBB0_10
	goto LBB0_9
LBB0_9:
.Ltmp18:
	.loc	3 49 9 is_stmt 1        # ../src/xdp_adjust_head.c:49:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_15
.Ltmp19:
LBB0_10:
	.loc	3 52 11                 # ../src/xdp_adjust_head.c:52:11
	r1 = *(u64 *)(r10 - 24)
	.loc	3 52 16 is_stmt 0       # ../src/xdp_adjust_head.c:52:16
	r1 += 14
	.loc	3 52 9                  # ../src/xdp_adjust_head.c:52:9
	*(u64 *)(r10 - 48) = r1
.Ltmp20:
	.loc	3 54 9 is_stmt 1        # ../src/xdp_adjust_head.c:54:9
	r1 = *(u64 *)(r10 - 48)
	.loc	3 54 13 is_stmt 0       # ../src/xdp_adjust_head.c:54:13
	r1 += 20
	.loc	3 54 35                 # ../src/xdp_adjust_head.c:54:35
	r2 = *(u64 *)(r10 - 32)
.Ltmp21:
	.loc	3 54 9                  # ../src/xdp_adjust_head.c:54:9
	if r2 >= r1 goto LBB0_12
	goto LBB0_11
LBB0_11:
.Ltmp22:
	.loc	3 56 9 is_stmt 1        # ../src/xdp_adjust_head.c:56:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_15
.Ltmp23:
LBB0_12:
	.loc	3 59 12                 # ../src/xdp_adjust_head.c:59:12
	r1 = *(u64 *)(r10 - 24)
	.loc	3 59 44 is_stmt 0       # ../src/xdp_adjust_head.c:59:44
	r2 = *(u64 *)(r10 - 48)
	.loc	3 59 49                 # ../src/xdp_adjust_head.c:59:49
	r2 = *(u8 *)(r2 + 0)
	.loc	3 59 41                 # ../src/xdp_adjust_head.c:59:41
	r2 &= 15
	r2 <<= 2
	.loc	3 59 17                 # ../src/xdp_adjust_head.c:59:17
	r1 += r2
	.loc	3 59 41                 # ../src/xdp_adjust_head.c:59:41
	r1 += 14
	.loc	3 59 10                 # ../src/xdp_adjust_head.c:59:10
	*(u64 *)(r10 - 56) = r1
.Ltmp24:
	.loc	3 61 9 is_stmt 1        # ../src/xdp_adjust_head.c:61:9
	r1 = *(u64 *)(r10 - 56)
	.loc	3 61 14 is_stmt 0       # ../src/xdp_adjust_head.c:61:14
	r1 += 20
	.loc	3 61 37                 # ../src/xdp_adjust_head.c:61:37
	r2 = *(u64 *)(r10 - 32)
.Ltmp25:
	.loc	3 61 9                  # ../src/xdp_adjust_head.c:61:9
	if r2 >= r1 goto LBB0_14
	goto LBB0_13
LBB0_13:
.Ltmp26:
	.loc	3 63 9 is_stmt 1        # ../src/xdp_adjust_head.c:63:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_15
.Ltmp27:
LBB0_14:
	.loc	3 66 5                  # ../src/xdp_adjust_head.c:66:5
	r1 = 2
	*(u32 *)(r10 - 4) = r1
	goto LBB0_15
LBB0_15:
	.loc	3 67 1                  # ../src/xdp_adjust_head.c:67:1
	r0 = *(u32 *)(r10 - 4)
	exit
.Ltmp28:
.Lfunc_end0:
...
.Linfo_string1:
	.asciz	"../src/xdp_adjust_head.c" # string offset=54
.Linfo_string2:
	.asciz	"/home/dev/HelloWorld/assembly/scripts" # string offset=79
.Linfo_string3:
	.asciz	"bpf_xdp_adjust_head"   # string offset=117
.Linfo_string4:
...
.LpubNames_begin0:
	...
	.long	42                      # DIE offset
	.asciz	"bpf_xdp_adjust_head"   # External Name
	.long	0                       # End Mark
.LpubNames_end0:
