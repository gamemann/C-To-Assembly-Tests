...
.Lfunc_begin0:
	...
	.cfi_startproc
# %bb.0:
	.loc	1 10 13 prologue_end    # ../src/pointer_reassign.c:10:13
	pushq	%rax
	.cfi_def_cfa_offset 16
.Ltmp0:
	#DEBUG_VALUE: main:i <- 1
	movq	stdout(%rip), %rdi
	.loc	1 10 5 is_stmt 0        # ../src/pointer_reassign.c:10:5
	movl	$.L.str, %esi
	movl	$1, %edx
	movl	$1, %ecx
	xorl	%eax, %eax
...
.LpubNames_begin0:
	...
	.long	104                     # Compilation Unit Length
	.long	42                      # DIE offset
