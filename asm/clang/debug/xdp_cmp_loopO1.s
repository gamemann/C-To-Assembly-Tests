...
.Ltmp15:
.Ltmp16:
	.loc	0 20 9 is_stmt 0                # ../src/xdp_cmp_loop.c:20:9
.Ltmp17:
...
.Ltmp26:
.Ltmp27:
	.loc	0 27 9 is_stmt 0                # ../src/xdp_cmp_loop.c:27:9
.Ltmp28:
	if r1 > r2 goto LBB0_7
.Ltmp29:
.Ltmp30:
...
.Ltmp45:
	#DEBUG_VALUE: i <- $r2
	r0 = 1
	.loc	0 39 5 is_stmt 1                # ../src/xdp_cmp_loop.c:39:5
.Ltmp46:
	if r2 == 5 goto LBB0_7
.Ltmp47:
.Ltmp48:
...
.Ldebug_info_start0:
	...
	.byte	2                               # DW_AT_low_pc
	.long	.Ltmp57-.Ltmp41                 # DW_AT_high_pc
...
.Ldebug_addr_end0:
	...
	.long	11
	.long	5
	.long	671                             # BTF_KIND_INT(id = 11)
	.long	16777216                        # 0x1000000
	.long	4
	.long	32                              # 0x20
	.long	691                             # BTF_KIND_VAR(id = 12)
	.long	234881024                       # 0xe000000
	.long	10
	.long	1
	.long	699                             # BTF_KIND_DATASEC(id = 13)
	...
	.byte	0
	.ascii	"    struct udphdr *udph = data + sizeof(struct ethhdr) + (iph->ihl * 4);" # string offset=413
	.byte	0
	.ascii	"    if (udph + 1 > (struct udphdr *)data_end)" # string offset=486
	.byte	0
	.ascii	"    if (pl + sizeof(payload) + 1 > (__u8 *)data_end)" # string offset=532
	.byte	0
	.ascii	"    for (int i = 0; i < sizeof(payload); i++)" # string offset=585
	.byte	0
	.ascii	"        if (pl[i] != payload[i])" # string offset=631
	.byte	0
	.byte	125                             # string offset=664
	.byte	0
	.ascii	"char"                          # string offset=666
	.byte	0
	.ascii	"__ARRAY_SIZE_TYPE__"           # string offset=671
	.byte	0
	.ascii	"payload"                       # string offset=691
	.byte	0
	.ascii	".rodata"                       # string offset=699
	.byte	0
