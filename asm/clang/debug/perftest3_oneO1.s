...
.Ltmp0:
	#DEBUG_VALUE: main:data <- [DW_OP_LLVM_fragment 0 32] 0
	#DEBUG_VALUE: main:data <- [DW_OP_LLVM_fragment 32 16] 0
	#DEBUG_VALUE: main:data <- [DW_OP_LLVM_fragment 48 8] 0
	#DEBUG_VALUE: main:data <- [DW_OP_LLVM_fragment 56 8] 0
	#DEBUG_VALUE: main:data <- [DW_OP_LLVM_fragment 0 32] 1235123
	#DEBUG_VALUE: main:data <- [DW_OP_LLVM_fragment 32 16] -23215
	#DEBUG_VALUE: main:data <- [DW_OP_LLVM_fragment 48 8] -6
	.loc	0 26 5 prologue_end             # ../src/perftest3_one.c:26:5
	callq	print_struct
.Ltmp1:
...
# %bb.0:
	...
	#DEBUG_VALUE: print_struct:data <- [DW_OP_LLVM_fragment 48 8] -6
	#DEBUG_VALUE: print_struct:data <- [DW_OP_stack_value, DW_OP_LLVM_fragment 56 8] 0
	pushq	%rax
	.cfi_def_cfa_offset 16
.Ltmp3:
	...
	callq	printf@PLT
.Ltmp4:
	.loc	0 15 5                          # ../src/perftest3_one.c:15:5
	leaq	.L.str.1(%rip), %rdi
	movl	$1235123, %esi                  # imm = 0x12D8B3
	xorl	%eax, %eax
	callq	printf@PLT
.Ltmp5:
	.loc	0 16 5                          # ../src/perftest3_one.c:16:5
	leaq	.L.str.2(%rip), %rdi
	movl	$42321, %esi                    # imm = 0xA551
	xorl	%eax, %eax
	callq	printf@PLT
.Ltmp6:
	.loc	0 17 5                          # ../src/perftest3_one.c:17:5
	leaq	.L.str.3(%rip), %rdi
	movl	$250, %esi
	xorl	%eax, %eax
	callq	printf@PLT
.Ltmp7:
	.loc	0 18 1                          # ../src/perftest3_one.c:18:1
	popq	%rax
	.cfi_def_cfa_offset 8
	retq
.Ltmp8:
...
.Ldebug_info_start0:
	...
	.byte	1                               # Abbrev [1] 0xc:0xa1 DW_TAG_compile_unit
	...
	.byte	0                               # End Of Children Mark
	.byte	8                               # Abbrev [8] 0x88:0x8 DW_TAG_typedef
	.long	144                             # DW_AT_type
	.byte	9                               # DW_AT_name
	.byte	1                               # DW_AT_decl_file
	.byte	27                              # DW_AT_decl_line
	.byte	7                               # Abbrev [7] 0x90:0x4 DW_TAG_base_type
	.byte	8                               # DW_AT_name
	...
	.byte	7                               # Abbrev [7] 0x9c:0x4 DW_TAG_base_type
	.byte	11                              # DW_AT_name
	.byte	7                               # DW_AT_encoding
	.byte	2                               # DW_AT_byte_size
	.byte	8                               # Abbrev [8] 0xa0:0x8 DW_TAG_typedef
	.long	168                             # DW_AT_type
	.byte	15                              # DW_AT_name
	.byte	1                               # DW_AT_decl_file
	.byte	21                              # DW_AT_decl_line
	.byte	7                               # Abbrev [7] 0xa8:0x4 DW_TAG_base_type
	.byte	14                              # DW_AT_name
