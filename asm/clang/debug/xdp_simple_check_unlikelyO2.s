...
.Ltmp1:
	...
	.loc	0 15 41 prologue_end            # ../src/xdp_simple_check_unlikely.c:15:41
.Ltmp2:
	r2 = *(u32 *)(r1 + 4)
	.loc	0 14 37                         # ../src/xdp_simple_check_unlikely.c:14:37
.Ltmp3:
	r3 = *(u32 *)(r1 + 0)
.Ltmp4:
.Ltmp5:
	...
	.loc	0 19 9                          # ../src/xdp_simple_check_unlikely.c:19:9
.Ltmp6:
	r1 = r3
.Ltmp7:
.Ltmp8:
...
# %bb.2:
	#DEBUG_VALUE: xdp_prog_main:iph <- $r1
	#DEBUG_VALUE: xdp_prog_main:data_end <- $r2
	.loc	0 31 64 is_stmt 1               # ../src/xdp_simple_check_unlikely.c:31:64
.Ltmp20:
	r3 = *(u8 *)(r1 + 0)
	.loc	0 31 68 is_stmt 0               # ../src/xdp_simple_check_unlikely.c:31:68
.Ltmp21:
	r3 <<= 2
	r3 &= 60
...
LBB0_4:
	#DEBUG_VALUE: xdp_prog_main:data_end <- $r2
	.loc	0 39 1 is_stmt 1                # ../src/xdp_simple_check_unlikely.c:39:1
.Ltmp35:
	exit
.Ltmp36:
.Ltmp37:
...
.Ldebug_addr_end0:
	...
	.byte	0
	.ascii	"/home/christian/C-To-Assembly-Tests/scripts/../src/xdp_simple_check_unlikely.c" # string offset=128
	.byte	0
	.ascii	"int xdp_prog_main(struct xdp_md *ctx)" # string offset=207
	.byte	0
	.ascii	"    void *data_end = (void *)(long)ctx->data_end;" # string offset=245
	.byte	0
	.ascii	"    void *data = (void *)(long)ctx->data;" # string offset=295
	.byte	0
	.ascii	"    if (unlikely(eth + 1 > (struct ethhdr *)data_end))" # string offset=337
	.byte	0
	.ascii	"    if (unlikely(iph + 1 > (struct iphdr *)data_end))" # string offset=392
	.byte	0
	.ascii	"    struct tcphdr *tcph = data + sizeof(struct ethhdr) + (iph->ihl * 4);" # string offset=446
	.byte	0
	.ascii	"    if (unlikely(tcph + 1 > (struct tcphdr *)data_end))" # string offset=519
	.byte	0
	.byte	125                             # string offset=575
	.byte	0
