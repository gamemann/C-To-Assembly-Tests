...
# %bb.0:
	...
	#DEBUG_VALUE: xdp_prog_main:ctx <- %r1
.Ltmp0:
	.loc	7 12 30 prologue_end    # ../src/xdp_simple_check.c:12:30
	r2 = *(u32 *)(r1 + 4)
.Ltmp1:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 11 26                 # ../src/xdp_simple_check.c:11:26
	r3 = *(u32 *)(r1 + 0)
.Ltmp2:
	#DEBUG_VALUE: xdp_prog_main:eth <- %r3
	.loc	7 16 13                 # ../src/xdp_simple_check.c:16:13
	r1 = r3
.Ltmp3:
	r1 += 14
.Ltmp4:
	.loc	7 16 9 is_stmt 0        # ../src/xdp_simple_check.c:16:9
...
# %bb.1:
	...
	.loc	7 23 13 is_stmt 1       # ../src/xdp_simple_check.c:23:13
	r3 += 34
.Ltmp6:
	.loc	7 23 9 is_stmt 0        # ../src/xdp_simple_check.c:23:9
	if r3 > r2 goto LBB0_4
.Ltmp7:
# %bb.2:
	#DEBUG_VALUE: xdp_prog_main:iph <- %r1
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 28 64 is_stmt 1       # ../src/xdp_simple_check.c:28:64
	r3 = *(u8 *)(r1 + 0)
	.loc	7 28 68 is_stmt 0       # ../src/xdp_simple_check.c:28:68
	r3 <<= 2
	r3 &= 60
...
.Ltmp8:
	...
	.loc	7 30 14 is_stmt 1       # ../src/xdp_simple_check.c:30:14
	r1 += 20
.Ltmp9:
	.loc	7 0 14 is_stmt 0        # ../src/xdp_simple_check.c:0:14
	r0 = 1
.Ltmp10:
...
# %bb.3:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 0 9 is_stmt 0         # ../src/xdp_simple_check.c:0:9
	r0 = 2
.Ltmp12:
LBB0_4:
	#DEBUG_VALUE: xdp_prog_main:data_end <- %r2
	.loc	7 36 1 is_stmt 1        # ../src/xdp_simple_check.c:36:1
	exit
.Ltmp13:
.Lfunc_end0:
	.cfi_endproc
