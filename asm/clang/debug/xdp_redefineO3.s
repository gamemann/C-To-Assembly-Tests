...
.Ltmp1:
	...
	.loc	0 12 41 prologue_end            # ../src/xdp_redefine.c:12:41
.Ltmp2:
	r2 = *(u32 *)(r1 + 4)
	.loc	0 11 37                         # ../src/xdp_redefine.c:11:37
.Ltmp3:
	r3 = *(u32 *)(r1 + 0)
.Ltmp4:
.Ltmp5:
	...
	.loc	0 16 13                         # ../src/xdp_redefine.c:16:13
.Ltmp6:
	r1 = r3
.Ltmp7:
.Ltmp8:
...
.Ltmp9:
.Ltmp10:
	.loc	0 16 9 is_stmt 0                # ../src/xdp_redefine.c:16:9
.Ltmp11:
...
# %bb.1:
	...
	.loc	0 23 13 is_stmt 1               # ../src/xdp_redefine.c:23:13
.Ltmp14:
	r3 += 34
.Ltmp15:
.Ltmp16:
	.loc	0 23 9 is_stmt 0                # ../src/xdp_redefine.c:23:9
.Ltmp17:
...
# %bb.2:
	#DEBUG_VALUE: xdp_prog_main:iph <- $r1
	#DEBUG_VALUE: xdp_prog_main:data_end <- $r2
	.loc	0 28 64 is_stmt 1               # ../src/xdp_redefine.c:28:64
.Ltmp20:
	r3 = *(u8 *)(r1 + 0)
	.loc	0 28 68 is_stmt 0               # ../src/xdp_redefine.c:28:68
.Ltmp21:
	r3 <<= 2
	r3 &= 60
...
.Ltmp24:
	...
	.loc	0 30 14 is_stmt 1               # ../src/xdp_redefine.c:30:14
.Ltmp25:
	r1 += 20
.Ltmp26:
.Ltmp27:
	.loc	0 0 14 is_stmt 0                # ../src/xdp_redefine.c:0:14
	r0 = 1
.Ltmp28:
.Ltmp29:
...
LBB0_4:
	#DEBUG_VALUE: xdp_prog_main:data_end <- $r2
	.loc	0 60 1 is_stmt 1                # ../src/xdp_redefine.c:60:1
.Ltmp35:
	exit
.Ltmp36:
.Ltmp37:
...
.Ldebug_addr_end0:
	...
	.byte	0
	.ascii	"/home/christian/C-To-Assembly-Tests/scripts/../src/xdp_redefine.c" # string offset=128
	.byte	0
	.ascii	"int xdp_prog_main(struct xdp_md *ctx)" # string offset=194
	.byte	0
	.ascii	"    void *data_end = (void *)(long)ctx->data_end;" # string offset=232
	.byte	0
	.ascii	"    void *data = (void *)(long)ctx->data;" # string offset=282
	.byte	0
	.ascii	"    if (eth + 1 > (struct ethhdr *)data_end)" # string offset=324
	.byte	0
	.ascii	"    if (iph + 1 > (struct iphdr *)data_end)" # string offset=369
	.byte	0
	.ascii	"    struct tcphdr *tcph = data + sizeof(struct ethhdr) + (iph->ihl * 4);" # string offset=413
	.byte	0
	.ascii	"    if (tcph + 1 > (struct tcphdr *)data_end)" # string offset=486
	.byte	0
	.byte	125                             # string offset=532
	.byte	0
