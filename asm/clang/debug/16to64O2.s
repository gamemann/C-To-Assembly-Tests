...
.Ltmp0:
	#DEBUG_VALUE: main:tmp <- 8128420497544
	#DEBUG_VALUE: main:val <- undef
	.loc	0 20 5 prologue_end             # ../src/16to64.c:20:5
	leaq	.L.str(%rip), %rdi
	movabsq	$8128420497544, %rsi            # imm = 0x7648B9DC888
	xorl	%eax, %eax
	callq	printf@PLT
.Ltmp1:
	.loc	0 22 5                          # ../src/16to64.c:22:5
	xorl	%eax, %eax
	popq	%rcx
...
.Ldebug_info_start0:
	...
	.ascii	"\210\221\367\334\310\354\001"  # DW_AT_const_value
	.byte	7                               # DW_AT_name
	.byte	0                               # DW_AT_decl_file
