...
.Lfunc_begin0:
	.file	7 "../src" "xdp_drop_port8080.c"
	.loc	7 16 0                  # ../src/xdp_drop_port8080.c:16:0
...
# %bb.0:
	...
	*(u64 *)(r10 - 16) = r1
.Ltmp0:
	.loc	7 17 32 prologue_end    # ../src/xdp_drop_port8080.c:17:32
	r1 = *(u64 *)(r10 - 16)
	.loc	7 17 26 is_stmt 0       # ../src/xdp_drop_port8080.c:17:26
	r1 = *(u32 *)(r1 + 0)
	.loc	7 17 11                 # ../src/xdp_drop_port8080.c:17:11
	*(u64 *)(r10 - 24) = r1
	.loc	7 18 36 is_stmt 1       # ../src/xdp_drop_port8080.c:18:36
	r1 = *(u64 *)(r10 - 16)
	.loc	7 18 30 is_stmt 0       # ../src/xdp_drop_port8080.c:18:30
	r1 = *(u32 *)(r1 + 4)
	.loc	7 18 11                 # ../src/xdp_drop_port8080.c:18:11
	*(u64 *)(r10 - 32) = r1
	.loc	7 20 26 is_stmt 1       # ../src/xdp_drop_port8080.c:20:26
	r1 = *(u64 *)(r10 - 24)
	.loc	7 20 20 is_stmt 0       # ../src/xdp_drop_port8080.c:20:20
	*(u64 *)(r10 - 40) = r1
.Ltmp1:
	.loc	7 22 9 is_stmt 1        # ../src/xdp_drop_port8080.c:22:9
	r1 = *(u64 *)(r10 - 40)
	.loc	7 22 13 is_stmt 0       # ../src/xdp_drop_port8080.c:22:13
	r1 += 14
	.loc	7 22 36                 # ../src/xdp_drop_port8080.c:22:36
	r3 = *(u64 *)(r10 - 32)
.Ltmp2:
	.loc	7 22 9                  # ../src/xdp_drop_port8080.c:22:9
	*(u64 *)(r10 - 64) = r2
	if r3 >= r1 goto LBB0_2
	goto LBB0_1
LBB0_1:
.Ltmp3:
	.loc	7 24 9 is_stmt 1        # ../src/xdp_drop_port8080.c:24:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_9
.Ltmp4:
LBB0_2:
	.loc	7 27 25                 # ../src/xdp_drop_port8080.c:27:25
	r1 = *(u64 *)(r10 - 24)
	.loc	7 27 30 is_stmt 0       # ../src/xdp_drop_port8080.c:27:30
	r1 += 14
	.loc	7 27 19                 # ../src/xdp_drop_port8080.c:27:19
	*(u64 *)(r10 - 48) = r1
.Ltmp5:
	.loc	7 29 9 is_stmt 1        # ../src/xdp_drop_port8080.c:29:9
	r1 = *(u64 *)(r10 - 48)
	.loc	7 29 13 is_stmt 0       # ../src/xdp_drop_port8080.c:29:13
	r1 += 20
	.loc	7 29 35                 # ../src/xdp_drop_port8080.c:29:35
	r2 = *(u64 *)(r10 - 32)
.Ltmp6:
	.loc	7 29 9                  # ../src/xdp_drop_port8080.c:29:9
	if r2 >= r1 goto LBB0_4
	goto LBB0_3
LBB0_3:
.Ltmp7:
	.loc	7 31 9 is_stmt 1        # ../src/xdp_drop_port8080.c:31:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_9
.Ltmp8:
LBB0_4:
	.loc	7 34 27                 # ../src/xdp_drop_port8080.c:34:27
	r1 = *(u64 *)(r10 - 24)
	.loc	7 34 59 is_stmt 0       # ../src/xdp_drop_port8080.c:34:59
	r2 = *(u64 *)(r10 - 48)
	.loc	7 34 64                 # ../src/xdp_drop_port8080.c:34:64
	r2 = *(u8 *)(r2 + 0)
	.loc	7 34 56                 # ../src/xdp_drop_port8080.c:34:56
	r2 &= 15
	r2 <<= 2
	.loc	7 34 32                 # ../src/xdp_drop_port8080.c:34:32
	r1 += r2
	.loc	7 34 56                 # ../src/xdp_drop_port8080.c:34:56
	r1 += 14
	.loc	7 34 20                 # ../src/xdp_drop_port8080.c:34:20
	*(u64 *)(r10 - 56) = r1
.Ltmp9:
	.loc	7 36 9 is_stmt 1        # ../src/xdp_drop_port8080.c:36:9
	r1 = *(u64 *)(r10 - 56)
	.loc	7 36 14 is_stmt 0       # ../src/xdp_drop_port8080.c:36:14
	r1 += 20
	.loc	7 36 37                 # ../src/xdp_drop_port8080.c:36:37
	r2 = *(u64 *)(r10 - 32)
.Ltmp10:
	.loc	7 36 9                  # ../src/xdp_drop_port8080.c:36:9
	if r2 >= r1 goto LBB0_6
	goto LBB0_5
LBB0_5:
.Ltmp11:
	.loc	7 38 9 is_stmt 1        # ../src/xdp_drop_port8080.c:38:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_9
.Ltmp12:
LBB0_6:
	.loc	7 41 9                  # ../src/xdp_drop_port8080.c:41:9
	r1 = *(u64 *)(r10 - 56)
	.loc	7 41 15 is_stmt 0       # ../src/xdp_drop_port8080.c:41:15
	r1 = *(u16 *)(r1 + 2)
.Ltmp13:
	.loc	7 41 9                  # ../src/xdp_drop_port8080.c:41:9
...
LBB0_7:
.Ltmp14:
	.loc	7 43 9 is_stmt 1        # ../src/xdp_drop_port8080.c:43:9
	r1 = 1
	*(u32 *)(r10 - 4) = r1
	goto LBB0_9
.Ltmp15:
LBB0_8:
	.loc	7 46 5                  # ../src/xdp_drop_port8080.c:46:5
	r1 = 2
	*(u32 *)(r10 - 4) = r1
	goto LBB0_9
LBB0_9:
	.loc	7 47 1                  # ../src/xdp_drop_port8080.c:47:1
	r0 = *(u32 *)(r10 - 4)
	exit
.Ltmp16:
.Lfunc_end0:
...
.Linfo_string1:
	.asciz	"../src/xdp_drop_port8080.c" # string offset=54
.Linfo_string2:
	.asciz	"/home/dev/HelloWorld/assembly/scripts" # string offset=81
.Linfo_string3:
	.asciz	"XDP_ABORTED"           # string offset=119
.Linfo_string4:
	.asciz	"XDP_DROP"              # string offset=131
.Linfo_string5:
	.asciz	"XDP_PASS"              # string offset=140
.Linfo_string6:
	.asciz	"XDP_TX"                # string offset=149
.Linfo_string7:
	.asciz	"XDP_REDIRECT"          # string offset=156
.Linfo_string8:
	.asciz	"xdp_action"            # string offset=169
.Linfo_string9:
	.asciz	"long int"              # string offset=180
.Linfo_string10:
	.asciz	"h_dest"                # string offset=189
.Linfo_string11:
	.asciz	"unsigned char"         # string offset=196
.Linfo_string12:
	.asciz	"sizetype"              # string offset=210
.Linfo_string13:
...
.Linfo_string32:
	.asciz	"__u32"                 # string offset=358
.Linfo_string33:
	.asciz	"__be32"                # string offset=364
.Linfo_string34:
	.asciz	"daddr"                 # string offset=371
.Linfo_string35:
	.asciz	"iphdr"                 # string offset=377
.Linfo_string36:
	.asciz	"source"                # string offset=383
.Linfo_string37:
	.asciz	"dest"                  # string offset=390
.Linfo_string38:
	.asciz	"seq"                   # string offset=395
.Linfo_string39:
	.asciz	"ack_seq"               # string offset=399
.Linfo_string40:
	.asciz	"res1"                  # string offset=407
.Linfo_string41:
	.asciz	"doff"                  # string offset=412
.Linfo_string42:
	.asciz	"fin"                   # string offset=417
.Linfo_string43:
	.asciz	"syn"                   # string offset=421
.Linfo_string44:
	.asciz	"rst"                   # string offset=425
.Linfo_string45:
	.asciz	"psh"                   # string offset=429
.Linfo_string46:
	.asciz	"ack"                   # string offset=433
.Linfo_string47:
	.asciz	"urg"                   # string offset=437
.Linfo_string48:
	.asciz	"ece"                   # string offset=441
.Linfo_string49:
	.asciz	"cwr"                   # string offset=445
.Linfo_string50:
	.asciz	"window"                # string offset=449
.Linfo_string51:
	.asciz	"urg_ptr"               # string offset=456
.Linfo_string52:
	.asciz	"tcphdr"                # string offset=464
.Linfo_string53:
	.asciz	"xdp_prog_main"         # string offset=471
.Linfo_string54:
	.asciz	"int"                   # string offset=485
.Linfo_string55:
	.asciz	"ctx"                   # string offset=489
.Linfo_string56:
	.asciz	"data"                  # string offset=493
.Linfo_string57:
	.asciz	"data_end"              # string offset=498
.Linfo_string58:
	.asciz	"data_meta"             # string offset=507
.Linfo_string59:
	.asciz	"ingress_ifindex"       # string offset=517
.Linfo_string60:
	.asciz	"rx_queue_index"        # string offset=533
.Linfo_string61:
	.asciz	"egress_ifindex"        # string offset=548
.Linfo_string62:
	.asciz	"xdp_md"                # string offset=563
.Linfo_string63:
	.asciz	"eth"                   # string offset=570
.Linfo_string64:
	.asciz	"iph"                   # string offset=574
.Linfo_string65:
	.asciz	"tcph"                  # string offset=578
