...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/64.c" md5 0x9d73e23e4eaa1571b97b6d64aa0abe72
	.loc	0 5 0                           # ../src/64.c:5:0
	.cfi_startproc
# %bb.0:
	pushq	%rax
	.cfi_def_cfa_offset 16
.Ltmp0:
	#DEBUG_VALUE: main:val <- 8128420482184
	.loc	0 9 5 prologue_end              # ../src/64.c:9:5
	leaq	.L.str(%rip), %rdi
	movabsq	$8128420482184, %rsi            # imm = 0x7648B9D8C88
	xorl	%eax, %eax
	callq	printf@PLT
.Ltmp1:
	.loc	0 11 5                          # ../src/64.c:11:5
	xorl	%eax, %eax
	popq	%rcx
...
.Ldebug_info_start0:
	...
	.byte	2                               # Abbrev [2] 0x23:0x1f DW_TAG_subprogram
	.byte	0                               # DW_AT_low_pc
	.long	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
	...
	.long	66                              # DW_AT_type
                                        # DW_AT_external
	.byte	3                               # Abbrev [3] 0x32:0xf DW_TAG_variable
...
.Linfo_string1:
	.asciz	"../src/64.c"                   # string offset=28
.Linfo_string2:
...
.Linfo_string5:
	.asciz	"val"                           # string offset=93
.Linfo_string6:
	.asciz	"unsigned long long"            # string offset=97
.Linfo_string7:
	.asciz	"__u64"                         # string offset=116
	.section	.debug_str_offsets,"",@progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
