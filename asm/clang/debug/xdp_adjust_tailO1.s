...
.Ltmp3:
	...
	.loc	0 14 41 prologue_end            # ../src/xdp_adjust_tail.c:14:41
.Ltmp4:
	r1 = *(u32 *)(r6 + 4)
	.loc	0 13 37                         # ../src/xdp_adjust_tail.c:13:37
.Ltmp5:
	r3 = *(u32 *)(r6 + 0)
.Ltmp6:
.Ltmp7:
	...
	.loc	0 18 13                         # ../src/xdp_adjust_tail.c:18:13
.Ltmp8:
	r2 = r3
	r2 += 14
.Ltmp9:
.Ltmp10:
	.loc	0 18 9 is_stmt 0                # ../src/xdp_adjust_tail.c:18:9
.Ltmp11:
...
# %bb.1:
	...
	.loc	0 25 13 is_stmt 1               # ../src/xdp_adjust_tail.c:25:13
.Ltmp14:
	r3 += 34
.Ltmp15:
.Ltmp16:
	.loc	0 0 13 is_stmt 0                # ../src/xdp_adjust_tail.c:0:13
	r0 = 1
.Ltmp17:
.Ltmp18:
...
# %bb.2:
	...
	#DEBUG_VALUE: xdp_prog_main:data_end <- $r1
	#DEBUG_VALUE: xdp_prog_main:ctx <- $r6
	.loc	0 30 64 is_stmt 1               # ../src/xdp_adjust_tail.c:30:64
.Ltmp22:
	r3 = *(u8 *)(r2 + 0)
	.loc	0 30 68 is_stmt 0               # ../src/xdp_adjust_tail.c:30:68
.Ltmp23:
	r3 <<= 2
	r3 &= 60
...
.Ltmp26:
	...
	.loc	0 32 14 is_stmt 1               # ../src/xdp_adjust_tail.c:32:14
.Ltmp27:
	r2 += 20
.Ltmp28:
.Ltmp29:
	.loc	0 0 14 is_stmt 0                # ../src/xdp_adjust_tail.c:0:14
	r0 = 1
.Ltmp30:
.Ltmp31:
...
# %bb.3:
	#DEBUG_VALUE: xdp_prog_main:data_end <- $r1
	#DEBUG_VALUE: xdp_prog_main:ctx <- $r6
	.loc	0 37 9 is_stmt 1                # ../src/xdp_adjust_tail.c:37:9
.Ltmp35:
	r1 = r6
.Ltmp36:
.Ltmp37:
...
.Ltmp39:
.Ltmp40:
	.loc	0 37 9 is_stmt 0                # ../src/xdp_adjust_tail.c:37:9
.Ltmp41:
	if r1 != 0 goto LBB0_8
.Ltmp42:
.Ltmp43:
# %bb.4:
	#DEBUG_VALUE: xdp_prog_main:ctx <- $r6
	#DEBUG_VALUE: xdp_prog_main:data <- undef
	.loc	0 43 35 is_stmt 1               # ../src/xdp_adjust_tail.c:43:35
.Ltmp44:
	r1 = *(u32 *)(r6 + 4)
	.loc	0 42 31                         # ../src/xdp_adjust_tail.c:42:31
.Ltmp45:
	r3 = *(u32 *)(r6 + 0)
.Ltmp46:
.Ltmp47:
	#DEBUG_VALUE: xdp_prog_main:eth <- $r3
	#DEBUG_VALUE: xdp_prog_main:data_end <- $r1
	.loc	0 47 13                         # ../src/xdp_adjust_tail.c:47:13
.Ltmp48:
	r2 = r3
	r2 += 14
	r0 = 1
.Ltmp49:
.Ltmp50:
	.loc	0 47 9 is_stmt 0                # ../src/xdp_adjust_tail.c:47:9
.Ltmp51:
	if r2 > r1 goto LBB0_8
.Ltmp52:
.Ltmp53:
# %bb.5:
	...
	#DEBUG_VALUE: xdp_prog_main:data <- $r3
	#DEBUG_VALUE: xdp_prog_main:iph <- $r2
	.loc	0 54 13 is_stmt 1               # ../src/xdp_adjust_tail.c:54:13
.Ltmp54:
	r3 += 34
.Ltmp55:
.Ltmp56:
...
# %bb.6:
	...
	#DEBUG_VALUE: xdp_prog_main:data_end <- $r1
	#DEBUG_VALUE: xdp_prog_main:ctx <- $r6
	.loc	0 59 49 is_stmt 1               # ../src/xdp_adjust_tail.c:59:49
.Ltmp62:
	r3 = *(u8 *)(r2 + 0)
	.loc	0 59 53 is_stmt 0               # ../src/xdp_adjust_tail.c:59:53
.Ltmp63:
	r3 <<= 2
	r3 &= 60
...
.Ltmp66:
	#DEBUG_VALUE: xdp_prog_main:tcph <- $r2
	.loc	0 61 14 is_stmt 1               # ../src/xdp_adjust_tail.c:61:14
.Ltmp67:
	r2 += 20
.Ltmp68:
.Ltmp69:
...
LBB0_8:
	#DEBUG_VALUE: xdp_prog_main:ctx <- $r6
	.loc	0 67 1 is_stmt 1                # ../src/xdp_adjust_tail.c:67:1
.Ltmp77:
	exit
.Ltmp78:
.Ltmp79:
...
.Ldebug_addr_end0:
	...
	.byte	0
	.ascii	"/home/christian/C-To-Assembly-Tests/scripts/../src/xdp_adjust_tail.c" # string offset=128
	.byte	0
	...
	.byte	0
	.ascii	"    if (bpf_xdp_adjust_tail(ctx, (int)32) != 0)" # string offset=535
	.byte	0
