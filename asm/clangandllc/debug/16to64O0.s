	.text
	.file	"16to64.c"
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/16to64.c" md5 0x1b6f21429f3091f2ffba31ebe4d2c4a3
...
# %bb.0:
	...
	movl	$0, -4(%rbp)
.Ltmp0:
	.loc	0 9 11 prologue_end             # ../src/16to64.c:9:11
	movq	.L__const.main.tmp, %rax
	movq	%rax, -12(%rbp)
	.loc	0 18 28                         # ../src/16to64.c:18:28
	leaq	-12(%rbp), %rax
	.loc	0 18 12 is_stmt 0               # ../src/16to64.c:18:12
	movq	%rax, -24(%rbp)
	.loc	0 20 34 is_stmt 1               # ../src/16to64.c:20:34
	movq	-24(%rbp), %rax
	.loc	0 20 33 is_stmt 0               # ../src/16to64.c:20:33
	movq	(%rax), %rsi
	.loc	0 20 5                          # ../src/16to64.c:20:5
	movabsq	$.L.str, %rdi
	movb	$0, %al
	callq	printf@PLT
	.loc	0 22 5 is_stmt 1                # ../src/16to64.c:22:5
	xorl	%eax, %eax
	addq	$32, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.Linfo_string1:
	.asciz	"../src/16to64.c"               # string offset=28
.Linfo_string2:
...
.Linfo_string9:
	.asciz	"__u16"                         # string offset=141
.Linfo_string10:
	.asciz	"__ARRAY_SIZE_TYPE__"           # string offset=147
.Linfo_string11:
	.asciz	"val"                           # string offset=167
	.section	.debug_str_offsets,"",@progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
