	.text
	.file	"8to64.c"
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/8to64.c" md5 0x05ff78efbcc6dcc0a145d21a8097454d
...
# %bb.0:
	...
	movl	$0, -12(%rbp)
.Ltmp0:
	.loc	0 9 10 prologue_end             # ../src/8to64.c:9:10
	movq	.L__const.main.tmp, %rax
	movq	%rax, -20(%rbp)
	.loc	0 18 28                         # ../src/8to64.c:18:28
	leaq	-20(%rbp), %rax
	.loc	0 18 12 is_stmt 0               # ../src/8to64.c:18:12
	movq	%rax, -8(%rbp)
	.loc	0 20 34 is_stmt 1               # ../src/8to64.c:20:34
	movq	-8(%rbp), %rax
	.loc	0 20 33 is_stmt 0               # ../src/8to64.c:20:33
	movq	(%rax), %rsi
	.loc	0 20 5                          # ../src/8to64.c:20:5
	movabsq	$.L.str, %rdi
	movb	$0, %al
	callq	printf@PLT
	.loc	0 22 5 is_stmt 1                # ../src/8to64.c:22:5
	xorl	%eax, %eax
	addq	$32, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.Ldebug_info_start0:
	...
	.byte	5                               # Abbrev [5] 0x34:0x26 DW_TAG_subprogram
	.byte	0                               # DW_AT_low_pc
	.long	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
	...
	.byte	4                               # Abbrev [4] 0x5a:0x4 DW_TAG_base_type
	.byte	6                               # DW_AT_name
	.byte	5                               # DW_AT_encoding
	.byte	4                               # DW_AT_byte_size
	.byte	7                               # Abbrev [7] 0x5e:0xc DW_TAG_array_type
	.long	106                             # DW_AT_type
	.byte	8                               # Abbrev [8] 0x63:0x6 DW_TAG_subrange_type
	.long	118                             # DW_AT_type
	.byte	8                               # DW_AT_count
	.byte	0                               # End Of Children Mark
	.byte	3                               # Abbrev [3] 0x6a:0x8 DW_TAG_typedef
	.long	114                             # DW_AT_type
	.byte	9                               # DW_AT_name
	.byte	1                               # DW_AT_decl_file
	.byte	21                              # DW_AT_decl_line
	.byte	4                               # Abbrev [4] 0x72:0x4 DW_TAG_base_type
	.byte	8                               # DW_AT_name
...
.Linfo_string1:
	.asciz	"../src/8to64.c"                # string offset=28
.Linfo_string2:
...
.Linfo_string8:
	.asciz	"unsigned char"                 # string offset=125
.Linfo_string9:
	.asciz	"__u8"                          # string offset=139
.Linfo_string10:
	.asciz	"__ARRAY_SIZE_TYPE__"           # string offset=144
.Linfo_string11:
	.asciz	"val"                           # string offset=164
	.section	.debug_str_offsets,"",@progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
