...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/switch_simple.c" md5 0x43e7e6530060e1e5d2ef8021ab4cc676
	.loc	0 4 0                           # ../src/switch_simple.c:4:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	...
	movl	$0, -8(%rbp)
.Ltmp0:
	.loc	0 5 9 prologue_end              # ../src/switch_simple.c:5:9
	movl	$5, -4(%rbp)
	.loc	0 7 13                          # ../src/switch_simple.c:7:13
	movl	-4(%rbp), %eax
	.loc	0 7 5 is_stmt 0                 # ../src/switch_simple.c:7:5
	subl	$5, %eax
	jne	.LBB0_2
	jmp	.LBB0_1
.LBB0_1:
.Ltmp1:
	.loc	0 10 13 is_stmt 1               # ../src/switch_simple.c:10:13
	movabsq	$.L.str, %rdi
	movb	$0, %al
	callq	printf@PLT
.Ltmp2:
.LBB0_2:
	.loc	0 15 5                          # ../src/switch_simple.c:15:5
	xorl	%eax, %eax
	addq	$16, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.Linfo_string1:
	.asciz	"../src/switch_simple.c"        # string offset=28
.Linfo_string2:
