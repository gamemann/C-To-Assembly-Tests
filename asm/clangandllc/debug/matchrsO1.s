...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/matchrs.c" md5 0xa9344569defb7cdb4e890567cdf7599c
	.loc	0 10 0                          # ../src/matchrs.c:10:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	...
	movl	$0, -8(%rbp)
.Ltmp0:
	.loc	0 11 11 prologue_end            # ../src/matchrs.c:11:11
	movl	$0, -4(%rbp)
	.loc	0 13 11                         # ../src/matchrs.c:13:11
	movl	-4(%rbp), %eax
	orl	$1, %eax
	movl	%eax, -4(%rbp)
	.loc	0 14 11                         # ../src/matchrs.c:14:11
	movl	-4(%rbp), %eax
	orl	$2, %eax
	movl	%eax, -4(%rbp)
	.loc	0 15 11                         # ../src/matchrs.c:15:11
	movl	-4(%rbp), %eax
	orl	$4, %eax
	movl	%eax, -4(%rbp)
.Ltmp1:
	.loc	0 17 10                         # ../src/matchrs.c:17:10
	movl	-4(%rbp), %eax
	.loc	0 17 16 is_stmt 0               # ../src/matchrs.c:17:16
	andl	$7, %eax
	.loc	0 17 28                         # ../src/matchrs.c:17:28
	cmpl	$7, %eax
.Ltmp2:
	.loc	0 17 9                          # ../src/matchrs.c:17:9
	jne	.LBB0_2
# %bb.1:
.Ltmp3:
	.loc	0 19 9 is_stmt 1                # ../src/matchrs.c:19:9
	movabsq	$.L.str, %rdi
	movb	$0, %al
	callq	printf@PLT
.Ltmp4:
.LBB0_2:
	.loc	0 22 5                          # ../src/matchrs.c:22:5
	xorl	%eax, %eax
	addq	$16, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.Linfo_string1:
	.asciz	"../src/matchrs.c"              # string offset=28
.Linfo_string2:
...
.Linfo_string5:
	.asciz	"flags"                         # string offset=98
.Linfo_string6:
	.asciz	"unsigned int"                  # string offset=104
.Linfo_string7:
	.asciz	"__u32"                         # string offset=117
	.section	.debug_str_offsets,"",@progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
