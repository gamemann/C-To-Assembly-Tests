...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/perftest1_one.c" md5 0x1b8df2c8d9f49423b6d94e8b7e4d364f
	.loc	0 7 0                           # ../src/perftest1_one.c:7:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	...
	movl	$0, -8(%rbp)
.Ltmp0:
	.loc	0 8 10 prologue_end             # ../src/perftest1_one.c:8:10
	movb	$0, -1(%rbp)
	.loc	0 10 11                         # ../src/perftest1_one.c:10:11
	movzbl	-1(%rbp), %eax
	addl	$30, %eax
	movb	%al, -1(%rbp)
	.loc	0 11 11                         # ../src/perftest1_one.c:11:11
	movzbl	-1(%rbp), %eax
	movl	$10, %ecx
	cltd
	idivl	%ecx
	movb	%al, -1(%rbp)
	.loc	0 13 30                         # ../src/perftest1_one.c:13:30
	movzbl	-1(%rbp), %esi
	.loc	0 13 5 is_stmt 0                # ../src/perftest1_one.c:13:5
	movabsq	$.L.str, %rdi
	movb	$0, %al
	callq	printf@PLT
	.loc	0 15 5 is_stmt 1                # ../src/perftest1_one.c:15:5
	xorl	%eax, %eax
	addq	$16, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.Linfo_string1:
	.asciz	"../src/perftest1_one.c"        # string offset=28
.Linfo_string2:
...
.Linfo_string5:
	.asciz	"value"                         # string offset=104
.Linfo_string6:
	.asciz	"unsigned char"                 # string offset=110
.Linfo_string7:
	.asciz	"__u8"                          # string offset=124
	.section	.debug_str_offsets,"",@progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
