...
.Ltmp0:
	...
	.loc	2 9 10 prologue_end     # ../src/8to64.c:9:10
	movq	.Lmain.tmp, %rcx
	movq	%rcx, -20(%rbp)
	.loc	2 18 12                 # ../src/8to64.c:18:12
	movq	%rax, -8(%rbp)
	.loc	2 20 34                 # ../src/8to64.c:20:34
	movq	-8(%rbp), %rax
.Ltmp1:
	.loc	2 20 33 is_stmt 0       # ../src/8to64.c:20:33
	movq	(%rax), %rsi
	.loc	2 20 5                  # ../src/8to64.c:20:5
	movb	$0, %al
	callq	printf
	.loc	2 22 5 is_stmt 1        # ../src/8to64.c:22:5
	xorl	%eax, %eax
	addq	$32, %rsp
	popq	%rbp
	retq
...
.Linfo_string1:
	.asciz	"../src/8to64.c"        # string offset=54
.Linfo_string2:
...
.Linfo_string9:
	.asciz	"__u8"                  # string offset=163
.Linfo_string10:
	.asciz	"sizetype"              # string offset=168
.Linfo_string11:
	.asciz	"val"                   # string offset=177
