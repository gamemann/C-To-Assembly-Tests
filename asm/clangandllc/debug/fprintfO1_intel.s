...
main:                                   # @main
.Lfunc_begin0:
	.file	1 "../src/fprintf.c"
	.loc	1 4 0                   # ../src/fprintf.c:4:0
	.cfi_startproc
# %bb.0:
	push	rbp
...
.Ltmp0:
	.loc	1 5 13 prologue_end     # ../src/fprintf.c:5:13
	mov	rdi, qword ptr [stdout]
	.loc	1 5 5 is_stmt 0         # ../src/fprintf.c:5:5
	mov	al, 0
	call	fprintf
	.loc	1 7 5 is_stmt 1         # ../src/fprintf.c:7:5
	xor	eax, eax
	add	rsp, 16
	pop	rbp
	ret
...
.Linfo_string1:
	.asciz	"../src/fprintf.c"      # string offset=54
.Linfo_string2:
