...
.Ltmp0:
	.loc	2 8 11 prologue_end     # ../src/64to16.c:8:11
	mov	qword ptr [rbp - 16], rcx
.Ltmp1:
	#DEBUG_VALUE: main:val <- [%rax+0]
	.loc	2 13 21                 # ../src/64to16.c:13:21
	mov	rcx, qword ptr [rbp - 16]
	.loc	2 13 25 is_stmt 0       # ../src/64to16.c:13:25
	shr	rcx, 0
	.loc	2 13 14                 # ../src/64to16.c:13:14
	mov	dx, cx
	.loc	2 13 12                 # ../src/64to16.c:13:12
	mov	word ptr [rbp - 24], dx
	.loc	2 14 21 is_stmt 1       # ../src/64to16.c:14:21
	mov	rcx, qword ptr [rbp - 16]
	.loc	2 14 25 is_stmt 0       # ../src/64to16.c:14:25
	shr	rcx, 16
	.loc	2 14 14                 # ../src/64to16.c:14:14
	mov	dx, cx
	.loc	2 14 12                 # ../src/64to16.c:14:12
	mov	word ptr [rbp - 22], dx
	.loc	2 15 21 is_stmt 1       # ../src/64to16.c:15:21
	mov	rcx, qword ptr [rbp - 16]
	.loc	2 15 25 is_stmt 0       # ../src/64to16.c:15:25
	shr	rcx, 32
	.loc	2 15 14                 # ../src/64to16.c:15:14
	mov	dx, cx
	.loc	2 15 12                 # ../src/64to16.c:15:12
	mov	word ptr [rbp - 20], dx
	.loc	2 16 21 is_stmt 1       # ../src/64to16.c:16:21
	mov	rcx, qword ptr [rbp - 16]
	.loc	2 16 25 is_stmt 0       # ../src/64to16.c:16:25
	shr	rcx, 48
	.loc	2 16 14                 # ../src/64to16.c:16:14
	mov	dx, cx
	.loc	2 16 12                 # ../src/64to16.c:16:12
	mov	word ptr [rbp - 18], dx
	.loc	2 18 12 is_stmt 1       # ../src/64to16.c:18:12
	mov	qword ptr [rbp - 32], rax
	.loc	2 20 34                 # ../src/64to16.c:20:34
	mov	rax, qword ptr [rbp - 32]
.Ltmp2:
	.loc	2 20 33 is_stmt 0       # ../src/64to16.c:20:33
	mov	rsi, qword ptr [rax]
	.loc	2 20 5                  # ../src/64to16.c:20:5
	mov	al, 0
	call	printf
	xor	r8d, r8d
	.loc	2 22 5 is_stmt 1        # ../src/64to16.c:22:5
...
.Linfo_string1:
	.asciz	"../src/64to16.c"       # string offset=54
.Linfo_string2:
...
.Linfo_string9:
	.asciz	"unsigned short"        # string offset=154
.Linfo_string10:
	.asciz	"__u16"                 # string offset=169
.Linfo_string11:
	.asciz	"sizetype"              # string offset=175
.Linfo_string12:
	.asciz	"pval"                  # string offset=184
