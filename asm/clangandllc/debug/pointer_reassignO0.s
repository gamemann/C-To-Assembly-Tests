...
.Lfunc_begin0:
	...
	.loc	1 4 0                   # ../src/pointer_reassign.c:4:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
...
.Ltmp0:
	...
	.loc	1 5 9 prologue_end      # ../src/pointer_reassign.c:5:9
	movl	$1, -8(%rbp)
	.loc	1 7 10                  # ../src/pointer_reassign.c:7:10
	movq	%rax, -16(%rbp)
	.loc	1 8 7                   # ../src/pointer_reassign.c:8:7
	movq	%rax, -16(%rbp)
	.loc	1 10 13                 # ../src/pointer_reassign.c:10:13
	movq	stdout, %rdi
	.loc	1 10 42 is_stmt 0       # ../src/pointer_reassign.c:10:42
	movl	-8(%rbp), %edx
	.loc	1 10 46                 # ../src/pointer_reassign.c:10:46
	movq	-16(%rbp), %rax
.Ltmp1:
	.loc	1 10 45                 # ../src/pointer_reassign.c:10:45
	movl	(%rax), %ecx
	.loc	1 10 5                  # ../src/pointer_reassign.c:10:5
	movb	$0, %al
	callq	fprintf
	xorl	%ecx, %ecx
	.loc	1 12 5 is_stmt 1        # ../src/pointer_reassign.c:12:5
...
.Linfo_string1:
	.asciz	"../src/pointer_reassign.c" # string offset=54
.Linfo_string2:
