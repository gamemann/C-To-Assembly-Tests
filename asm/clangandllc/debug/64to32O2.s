	.text
	.file	"64to32.c"
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/64to32.c" md5 0xb385903e69d9b2746601928b94e702f8
...
# %bb.0:
	...
	movl	$0, -28(%rbp)
.Ltmp0:
	.loc	0 8 11 prologue_end             # ../src/64to32.c:8:11
	movabsq	$8128420482184, %rax            # imm = 0x7648B9D8C88
	movq	%rax, -8(%rbp)
	.loc	0 13 21                         # ../src/64to32.c:13:21
	movq	-8(%rbp), %rax
	.loc	0 13 25 is_stmt 0               # ../src/64to32.c:13:25
	shrq	$0, %rax
	.loc	0 13 12                         # ../src/64to32.c:13:12
	movl	%eax, -16(%rbp)
	.loc	0 14 21 is_stmt 1               # ../src/64to32.c:14:21
	movq	-8(%rbp), %rax
	.loc	0 14 25 is_stmt 0               # ../src/64to32.c:14:25
	shrq	$32, %rax
	.loc	0 14 12                         # ../src/64to32.c:14:12
	movl	%eax, -12(%rbp)
	.loc	0 16 29 is_stmt 1               # ../src/64to32.c:16:29
	leaq	-16(%rbp), %rax
	.loc	0 16 12 is_stmt 0               # ../src/64to32.c:16:12
	movq	%rax, -24(%rbp)
	.loc	0 18 34 is_stmt 1               # ../src/64to32.c:18:34
	movq	-24(%rbp), %rax
	.loc	0 18 33 is_stmt 0               # ../src/64to32.c:18:33
	movq	(%rax), %rsi
	.loc	0 18 5                          # ../src/64to32.c:18:5
	movabsq	$.L.str, %rdi
	movb	$0, %al
	callq	printf@PLT
	.loc	0 20 5 is_stmt 1                # ../src/64to32.c:20:5
	xorl	%eax, %eax
	addq	$32, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.Linfo_string1:
	.asciz	"../src/64to32.c"               # string offset=28
.Linfo_string2:
...
.Linfo_string10:
	.asciz	"__u32"                         # string offset=143
.Linfo_string11:
	.asciz	"__ARRAY_SIZE_TYPE__"           # string offset=149
.Linfo_string12:
	.asciz	"pval"                          # string offset=169
	.section	.debug_str_offsets,"",@progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
