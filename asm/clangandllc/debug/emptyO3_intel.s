...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/home/christian/C-To-Assembly-Tests/scripts" "../src/empty.c" md5 0x541dea4a59c3e27c4cca3a760725fd02
	.loc	0 2 0                           # ../src/empty.c:2:0
	.cfi_startproc
# %bb.0:
	push	rbp
...
.Ltmp0:
	.loc	0 3 5 prologue_end              # ../src/empty.c:3:5
	xor	eax, eax
	pop	rbp
	.cfi_def_cfa rsp, 8
	ret
...
.Linfo_string1:
	.asciz	"../src/empty.c"                # string offset=28
.Linfo_string2:
